...
const SourceRecordsRoute = ({ path }) => {
  ...
  const resultColumns = [
    ...
    },
    {
      ...
      label: (
        <FormattedMessage id="ui-remote-sync.prop.sourceRecord.sourceRecordId" />
      ),
    },
    {
      propertyPath: 'transformationStatus',
      label: (
        <FormattedMessage id="ui-remote-sync.prop.sourceRecord.transformationStatus" />
      ),
    },
    {
      propertyPath: 'processControlStatus',
      label: (
        <FormattedMessage id="ui-remote-sync.prop.sourceRecord.processControlStatus" />
      ),
    },
  ];
